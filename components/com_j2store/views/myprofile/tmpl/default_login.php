...
$guest_action_url = $platform->getMyprofileUrl(['task' => 'guestentry']);
...
<div class="j2store">
	<div class="<?php echo $J2gridRow; ?>">
		...
		<div class="<?php echo $J2gridCol; ?>5">
			<h3>
				<?php echo Text::_('J2STORE_LOGIN'); ?>
			</h3>
			<!-- LOGIN FORM -->
			<?php if (PluginHelper::isEnabled('authentication', 'openid')) :
			$lang->load( 'plg_authentication_openid', JPATH_ADMINISTRATOR );
			$langScript =   'var JLanguage = {};'.
					' JLanguage.WHAT_IS_OPENID = \''.Text::_( 'WHAT_IS_OPENID' ).'\';'.
					' JLanguage.LOGIN_WITH_OPENID = \''.Text::_( 'LOGIN_WITH_OPENID' ).'\';'.
					' JLanguage.NORMAL_LOGIN = \''.Text::_( 'NORMAL_LOGIN' ).'\';'.
					' var modlogin = 1;';
//			$document = Factory::getApplication()->getDocument();
//			$document->addScriptDeclaration( $langScript );
			...
			<form
				...
				<label for="username" class="j2storeUserName"><?php echo Text::_('J2STORE_USERNAME'); ?>


					<input type="text" name="username" class="inputbox required"
					alt="username"
					title="<?php echo Text::_('J2STORE_LOGIN_FORM_ENTER_USERNAME');?>" />
				</label> <label for="password" class="j2storePassword"><?php echo Text::_('J2STORE_PASSWORD'); ?>
					<input type="password" name="password" class="inputbox"
					alt="password"
					title="<?php echo Text::_('J2STORE_LOGIN_FORM_ENTER_PASSWORD');?>" />
				</label>
				<?php if (PluginHelper::isEnabled('system', 'remember')) : ?>

				<label for="remember"> <input type="checkbox" name="remember"
					class="inputbox" value="yes" /> <?php echo Text::_('J2STORE_REMEMBER_ME'); ?>
				</label>
				<?php endif; ?>
				<div class="clr"></div>
				<input type="submit" name="submit"
					class="j2store_checkout_button btn btn-primary"
					value="<?php echo Text::_('J2STORE_LOGIN') ?>" />
				<ul class="loginLinks">
					<li><?php // TODO Can we do this in a lightbox or something? Why does the user have to leave? ?>
						...
						href="<?php echo Route::_( 'index.php?option=com_users&view=reset' ); ?>">
							<?php echo Text::_('J2STORE_FORGOT_YOUR_PASSWORD'); ?>
					</a>
					</li>
					<li><?php // TODO Can we do this in a lightbox or something? Why does the user have to leave? ?>
						<a
						href="<?php echo Route::_( 'index.php?option=com_users&view=remind' ); ?>">
							<?php echo Text::_('J2STORE_FORGOT_YOUR_USERNAME'); ?>
					</a>
					</li>
                    ...
                    <?php if ($usersConfig->get('allowUserRegistration')) : ?>
                        <li>
                            <a href="<?php echo Route::_('index.php?option=com_users&view=registration'); ?>">
                                <?php echo Text::_('J2STORE_LOGIN_REGISTER'); ?></a>
                        </li>
                    <?php endif; ?>
				</ul>
				<input type="hidden" name="option" value="com_users" /> <input
					...
					value="<?php echo base64_encode( (string) $return_url ); ?>" />
...
<?php endif; ?>
		...
		<div class="<?php echo $J2gridCol; ?>6">
			<h3>
				<?php echo Text::_('J2STORE_ORDER_GUEST_VIEW'); ?>
			</h3>
			<small><?php echo Text::_('J2STORE_ORDER_GUEST_VIEW_DESC'); ?> </small>
			<!-- Registration form -->
			<form action="<?php echo $guest_action_url;?>" method="post"
				...
				<div class="j2store_register_fields">
					<label for="email"> <?php echo Text::_( 'J2STORE_ORDER_EMAIL' ); ?>
						*
					</label><input name="email" id="email" class="required email"
						type="text"
						title="<?php echo Text::_('J2STORE_VALIDATION_ENTER_VALID_EMAIL'); ?>" />
				</div>

				<div class="j2store_register_fields">
					<label for="order_token"> <?php echo Text::_( 'J2STORE_ORDER_TOKEN' ); ?>*
					</label> <input name="order_token" id="order_token"
						class="required" type="text"
						title="<?php echo Text::_('J2STORE_VALIDATION_ENTER_VALID_TOKEN'); ?>" />
				</div>
				<div class="j2store_register_fields">

					<input type="submit" name="submit"
						class="j2store_checkout_button btn btn-primary"
						value="<?php echo Text::_('J2STORE_VIEW') ?>" />
				</div>
				<?php echo JHTML::_( 'form.token' ); ?>
			</form>
		</div>
		<?php endif; ?>
		<?php echo J2Store::plugin()->eventWithHtml('MyProfileLogin', [$this]); ?>
	</div>
</div>
