...
<?php if($this->params->get('show_logout_myprofile',0)):?>
	...
	$return = base64_encode((string) $return_url);
	?>
                    ...
                    <li>
                  		<a href="#address-tab" data-toggle="tab">
                  			<i class="fa fa-globe"></i>
                  		 	<?php echo Text::_('J2STORE_MYPROFILE_ADDRESS'); ?>
                  		</a>
                  </li>
                  <?php endif; ?>
