...
<p>
  ...
  <label for="shipping-address-new"><?php echo Text::_('J2STORE_ADDRESS_NEW'); ?></label>
</p>
<?php endif; ?>
...
<?php echo J2Store::plugin()->eventWithHtml('CheckoutShipping', [$this]); ?>
<br>
<div class="buttons">
  <div class="left">
    <input type="button" value="<?php echo Text::_('J2STORE_CHECKOUT_CONTINUE'); ?>" id="button-shipping-address" class="button btn btn-primary" />
  </div>
</div>
