...
<?php } ?>
<?php echo J2Store::plugin()->eventWithHtml('CheckoutGuest', [$this]); ?>
<div class="buttons">
	<div class="left">
		<input type="button" value="<?php echo Text::_('J2STORE_CHECKOUT_CONTINUE'); ?>" id="button-guest" class="button btn btn-primary" />
	</div>
</div>
