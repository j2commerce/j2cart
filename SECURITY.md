...
The `J2Commerce` team takes all security bugs in `J2Store/J2Commerce` and its add-ons seriously.
...
Thank you for improving the security of `J2Store/J2Commerce`.
...
* `J2Commerce` will properly credit individuals and/or organizations who responsibly disclose security issues to our team.
