	...
	<div class="col-sm-12">
		<h3><?php echo JText::_('J2STORE_RELATED_PRODUCTS_UPSELLS'); ?></h3>
				<?php foreach($this->up_sells as $upsell_product):?>
					<?php
						$upsell_product->product_link = $platform->getProductUrl(array('task' => 'view','id' => $upsell_product->j2store_product_id),true);
                    ...
                    <div class="col-sm-<?php echo round((12 / $columns));?> upsell-product product-<?php echo $upsell_product->j2store_product_id;?> <?php echo isset($upsell_css) ? $this->escape($upsell_css):''; ?>  ">
                            ...
                            ?>
                                <?php if(isset($thumb_image) &&  !empty($thumb_image)):?>
                                    <?php  //echo "<pre>";print_r($thumb_image);exit; ?>
                                    <a href="<?php echo $upsell_product->product_link; ?>">
			   					    <img title="<?php echo $upsel_product_name ;?>"
                                         alt="<?php echo $upsel_product_name ;?>"
