	...
	<div class="col-sm-12">
		<h3><?php echo JText::_('J2STORE_RELATED_PRODUCTS_CROSS_SELLS'); ?></h3>
				...
				<?php foreach($this->cross_sells as $cross_sell_product):?>
					<?php
						$cross_sell_product->product_link = $platform->getProductUrl(array('task' => 'view', 'id' => $cross_sell_product->j2store_product_id), true);
                    //JRoute::_('index.php?option=com_j2store&view=producttags&task=view&id='.$cross_sell_product->j2store_product_id);
