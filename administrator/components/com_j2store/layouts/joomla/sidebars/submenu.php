...
<div id="j2store-navbar">
    <div class="d-none d-lg-flex align-items-center mb-3">
        <div class="j2store-social-share">
            <a class="btn btn-sm btn-primary px-2" href="https://www.facebook.com/j2commerce" onclick="return ! window.open(this.href);">
                <i class="fa-brands fab fa-facebook-f fa-fw" aria-hidden="true"></i>
            </a>
            <a class="btn btn-sm btn-primary px-2" href="https://github.com/j2commerce" onclick="return ! window.open(this.href);">
