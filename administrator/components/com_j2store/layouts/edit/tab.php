                        ...
                        <?php foreach ($vars->field_sets as $field_set):?>
                            <?php if(isset($field_set['fields']) && !empty($field_set['fields'])):?>
                                ...
                                <fieldset <?php echo isset($field_set['id']) && $field_set['id'] ? 'id="'.$field_set['id'].'"': '';?>
                                    <?php if (isset($field_set['class'])) : ?>
                                        <?php echo is_array($field_set['class']) ? ' class="' . implode(' ', $field_set['class']) . '"' : ($field_set['class'] ? ' class="' . $field_set['class'] . '"' : ''); ?>
                                    <?php endif; ?>
                                >
                                        ...
                                        <div class="form-grid">
                                            <?php foreach ($field_set['fields'] as $field_name => $field):?>
                                                ...
                                                <div class="control-group">
                                                    <?php if ((!isset($field['options']['hiddenLabel']) || !$field['options']['hiddenLabel']) && !empty($field['label'])) : ?>
