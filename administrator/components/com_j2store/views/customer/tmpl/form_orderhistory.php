...
?>
<h4><?php echo Text::_('J2STORE_ORDER_HISTORY');?></h4>
<table class="table table-striped table-condensed table-bordered">
	<thead>
		<tr>
			<th><?php echo Text::_("J2STORE_ORDER_DATE"); ?></th>
			<th><?php echo Text::_("J2STORE_ORDER_COMMENT"); ?></th>
	...
	<tr>
		<td>
			<?php echo JHTML::_('date', $history->created_on, $this->params->get('date_format', Text::_('DATE_FORMAT_LC1'))); ?>
		</td>
		<td>
			<?php echo Text::_($history->comment);?>
		</td>
		<td>
