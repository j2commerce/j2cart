...
<form class="form-horizontal form-validate" id="adminForm" name="adminForm" method="post" action="index.php">
	...
	<table class="admintable">
		<tr>
			<td width="100" align="right" class="key">
				<label for="option_unique_name">
					<?php echo Text::_( 'J2STORE_OPTION_UNIQUE_NAME' ); ?>:
				</label>
			</td>
			<td>
		...
		<tr>
			<td width="100" align="right" class="key">
				<label for="option_name">
					<?php echo Text::_( 'J2STORE_OPTION_DISPLAY_NAME' ); ?>:
				</label>
			</td>
			<td>
		...
		<tr>
			<td width="100" align="right" class="key">
				<label for="type">
					<?php echo Text::_( 'J2STORE_OPTION_TYPE' ); ?>:
				</label>
			</td>
			<td>
		...
		<tr>
			<td valign="top" align="right" class="key">
				<?php echo Text::_( 'J2STORE_OPTION_STATE' ); ?>:
			</td>
			<td>
...
<fieldset id="option-value">
	<div class="row-fluid">
		<div class="span9">
			<legend><h3><?php echo Text::_('J2STORE_OV_ADD_NEW_OPTION_VALUES');?></h3></legend>
				<table class="list table table-bordered table-stripped">
		          <thead>
		            <tr>
		              <td class="left"><span class="required">*</span> <?php echo Text::_('J2STORE_OPTION_VALUE_NAME'); ?></td>
		              <td><span><?php echo Text::_('J2STORE_OPTION_VALUE_IMAGE');?></span></td>
		              <td class="right"><?php echo Text::_('JGRID_HEADING_ORDERING'); ?></td>
		              <td><?php echo Text::_('J2STORE_REMOVE'); ?></td>
		            </tr>
		          </thead>
		          ...
		          <tbody id="option-value-row<?php echo $option_value_row; ?>">
		            <tr>
		              <td class="left">
		                ...
		                <input type="text" class="input-small" name="option_value[<?php echo $option_value_row; ?>][optionvalue_name]" value="<?php echo isset($option_value->optionvalue_name) ? Text::_($option_value->optionvalue_name): ''; ?>" />
		                <br>
		               </td>
		               <td class="right">
		               <div class="input-prepend input-append">

		               <?php if(File::exists(JPATH_SITE.'/'.$option_value->optionvalue_image)):?>
		               	<?php $optionvalueimage = Uri::root().'/'.$option_value->optionvalue_image;?>
		               	<?php elseif(File::exists(JPATH_SITE.'/media/j2store/images/common/no_image-100x100.jpg')):?>
						<?php $optionvalueimage = Uri::root().'media/j2store/images/common/no_image-100x100.jpg';?>
		               	<?php endif;?>
						...
						<?php endif;?>
							...
							<a class="modal btn btn-default " rel="{handler: 'iframe', size: {x: 800, y: 500}}"
								href="index.php?option=com_media&view=images&tmpl=component&asset=<?php echo $asset_id;?>&author=<?php echo Factory::getUser()->id;?>&fieldid=jform_optionvalue_image_<?php echo $option_value->j2store_optionvalue_id;?>&folder="
								title="<?php echo Text::_('PLG_J2STORE_EXTRAIMAGES_SELECT');?>">
								<?php echo Text::_('J2STORE_IMAGE_SELECT');?>
					 		</a>
					 		<a class="btn hasTooltip btn btn-inverse" onclick="removeImage('jform_optionvalue_image_<?php echo $option_value->j2store_optionvalue_id;?>')"  href="#" title=""  data-original-title="<?php echo Text::_('J2STORE_IMAGE_CLEAR');?>">
		              ...
		              <td class="left"><a class="btn btn-danger btn-mini" onclick="DeleteOptionValue(<?php echo $option_value->j2store_optionvalue_id	; ?>,<?php echo $option_value_row; ?>)" class="button"><?php echo Text::_('J2STORE_REMOVE'); ?></a></td>
		            </tr>
		          </tbody>
		          ...
		          <tfoot>
		            <tr>
		              <td  colspan="4"><a  href="javascript:void(0)" onclick="j2storeAddOptionValue();" class="btn btn-primary pull-right"><?php echo Text::_('J2STORE_OPTION_VALUE_ADD'); ?></a></td>
		            </tr>
		          </tfoot>
		        </table>
	        </div>
	        <div class="span3">
	        <legend><h3><?php echo Text::_('J2STORE_OPTIONVALUE_ADD_NEW_OPTION_VALUES_HELP');?></h3></legend>
	        	<div class="alert alert-info">
	        		<h4 class="alert-heading"><?php echo Text::_('J2STORE_OPTION_VALUE_IMAGE');?></h4>
	        		<p><?php echo Text::_('J2STORE_OPTION_VALUE_IMAGE_HELP');?></p>
	        	</div>
	        </div>
       </div>
</fieldset>
...
var vhref = "<?php echo "index.php?option=com_media&view=images&tmpl=component&asset=".$asset_id."&author=".Factory::getUser()->id."&fieldid=jform_main_image_";?>";
(function($) {
...
function j2storeAddOptionValue(){
	...
	html += '    <td class="left"><a onclick="j2store.jQuery(\'#option-value-row' + option_value_row + '\').remove();" class="button"><?php echo Text::_('J2STORE_REMOVE'); ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
