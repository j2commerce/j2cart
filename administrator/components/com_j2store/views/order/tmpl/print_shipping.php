...
<div class="<?php echo $row_class ?>">
	<div class="<?php echo $col_class ?>12">
				...
				<h4><?php echo Text::_('J2STORE_SHIPPING_ADDRESS');?> </h4>
					<?php echo '<strong>'.$this->orderinfo->shipping_first_name." ".$this->orderinfo->shipping_last_name."</strong><br>";
						...
						echo $this->orderinfo->shipping_zone_name ? Text::_($this->orderinfo->shipping_zone_name).'<br>' : "";
						echo $this->orderinfo->shipping_zip."<br>";
						echo Text::_($this->orderinfo->shipping_country_name)."<br>";
						echo Text::_('J2STORE_TELEPHONE') .': ';
