...
<div class="btn-toolbar w-100 justify-content-end mb-3">
    <div class="filter-search-bar btn-group flex-grow-1 flex-lg-grow-0 mb-2 mb-lg-0">
        <div class="input-group w-100">
	        ...
	        <?php echo J2Html::buttontype('reset', Text::_('JCLEAR'), ['id' => 'reset-filter-search', 'class' => 'btn btn-primary d-inline-block d-lg-none']); ?>
        </div>
    </div>
    <div class="filter-search-actions btn-group ms-lg-2 flex-grow-1 flex-lg-grow-0 mb-2 mb-lg-0">
		...
		<?php echo J2Html::buttontype('reset',Text::_( 'JCLEAR' ),['id'=>'reset-filter', 'class'=>'btn btn-primary']);?>
    </div>
    <div class="ordering-select d-flex gap-2 ms-lg-2 flex-grow-1 flex-lg-grow-0">
	    <?php echo J2Html::select()
		    ...
		    ->attribs(['onchange' => 'this.form.submit();', 'class' => 'form-select j2store-product-filters w-100'])
		    ->setPlaceHolders(['' => Text::_('J2STORE_SELECT_STATUS')])
