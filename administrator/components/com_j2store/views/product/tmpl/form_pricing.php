...
//pricing options
$variant_pricing_calculator = $this->variant->pricing_calculator ?? '';
    ...
    <fieldset class="options-form">
        ...
        <div class="form-grid">
            <div class="control-group">
                ...
                <div class="controls">
	                <?php echo J2Html::price($this->form_prefix.'[price]',$this->variant->price ?? '', ['class'=>'form-control']); ?>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls"><?php echo str_replace('<select', '<select class="form-select"', (string) $pricing_calculator); ?></div>
            </div>
        </div>
    </fieldset>
</div>
