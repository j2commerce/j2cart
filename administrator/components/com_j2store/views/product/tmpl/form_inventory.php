        ...
        <fieldset class="options-form">
            ...
            <div class="form-grid">
                <div class="control-group">
		            ...
		            <?php echo J2Html::radioBooleanList($this->form_prefix.'[manage_stock]', $this->variant->manage_stock ?? ''); ?>
                </div>
                <div class="control-group">
                    <div class="control-label"><?php echo J2Html::label(Text::_('J2STORE_PRODUCT_QUANTITY'), 'quantity');?></div>
                    <div class="controls">
                        <?php echo J2Html::hidden($this->form_prefix.'[quantity][j2store_productquantity_id]', $this->variant->j2store_productquantity_id ?? '',['class'=>'input']); ?>
                        <?php echo J2Html::text($this->form_prefix.'[quantity][quantity]', $this->variant->quantity ?? '',['class'=>'form-control', 'field_type'=>'integer', 'id'=>'quantityJ2Store_productquantity_id'.$this->variant->j2store_productquantity_id]); ?>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label"><?php echo J2Html::label(Text::_('J2STORE_PRODUCT_ALLOW_BACK_ORDERS'), 'allow_backorder');?></div>
                    <div class="controls"><?php echo str_replace('<select', '<select class="form-select"', (string) $this->allow_backorder); ?></div>
                </div>
                <div class="control-group">
                    <div class="control-label"><?php echo J2Html::label(Text::_('J2STORE_PRODUCT_STOCK_STATUS'), 'availability'); ?></div>
                    <div class="controls"><?php echo str_replace('<select', '<select class="form-select"', (string) $this->availability); ?></div>
                </div>
                <div class="control-group mb-0">
                    <div class="control-label"><?php echo J2Html::label(Text::_('J2STORE_PRODUCT_NOTIFY_QUANTITY'), 'notify_qty'); ?></div>
                    <div class="controls">
                        <div class="input-group align-items-center">
                            <?php $attribs = (isset($this->variant->use_store_config_notify_qty) && $this->variant->use_store_config_notify_qty) ? ['id'=>'notify_qty', 'disabled'=>'disabled', 'field_type'=>'integer', 'class'=>'form-control'] :['id'=>'notify_qty', 'field_type'=>'integer', 'class'=>'form-control'];
	                    echo J2Html::text($this->form_prefix.'[notify_qty]',$this->variant->notify_qty ?? '' ,$attribs); ?>
                ...
                <div class="control-group">
		            ...
		            <?php echo J2Html::radioBooleanList($this->form_prefix.'[quantity_restriction]',$this->variant->quantity_restriction ?? '' ); ?>
                </div>
                <div class="control-group mb-0">
                    <div class="control-label"><?php echo J2Html::label(Text::_('J2STORE_PRODUCT_MAX_SALE_QUANTITY'), 'max_sale_qty'); ?></div>
                    <div class="controls">
                        <div class="input-group align-items-center">
	                        <?php $attribs = (isset($this->variant->use_store_config_notify_qty) && $this->variant->use_store_config_notify_qty) ? ['id' =>'max_sale_qty', 'disabled'=>'', 'field_type'=>'integer', 'class'=>'form-control'] : ['id' =>'max_sale_qty', 'field_type'=>'integer', 'class'=>'form-control'];
	                        echo J2Html::text($this->form_prefix.'[max_sale_qty]',$this->variant->max_sale_qty ?? '' ,$attribs); ?>
                ...
                <div class="control-group mb-0">
                    ...
                    <div class="controls">
                        <div class="input-group align-items-center">
                        <?php $attribs = (isset($this->variant->use_store_config_notify_qty) && $this->variant->use_store_config_notify_qty) ? ['id'=>'min_sale_qty', 'disabled'=>'', 'field_type'=>'integer', 'class'=>'form-control'] :['id'=>'min_sale_qty', 'field_type'=>'integer', 'class'=>'form-control'];
                            echo J2Html::text($this->form_prefix.'[min_sale_qty]', $this->variant->min_sale_qty ?? '',$attribs); ?>
                            <div class="form-check form-switch pt-0 qty_restriction ms-3">
