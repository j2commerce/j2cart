    ...
    <fieldset class="options-form">
        ...
        <div class="form-grid">
            ...
            <div class="control-group">
			    ...
			    <div class="controls">
				    <?php echo J2Html::text($this->form_prefix.'[sku]',$this->variant->sku ?? '',['class'=>'form-control']); ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label"><?php echo J2Html::label(Text::_('J2STORE_PRODUCT_UPC'), 'upc'); ?></div>
                <div class="controls"><?php echo J2Html::text($this->form_prefix.'[upc]', $this->variant->upc ?? '',['class'=>'form-control']); ?></div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
	                <?php echo str_replace('<select', '<select class="form-select"', (string) $this->tag_lists); ?>
                </div>
            </div>
            <div class="control-group">
