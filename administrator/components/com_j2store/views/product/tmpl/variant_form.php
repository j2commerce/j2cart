...
?>
 <form class="form-horizontal form-validate" id="adminForm" name="adminForm" method="post" action="index.php">
 	<h4><?php  echo Text::_('J2STORE_PRODUCT_NAME');?></h4>
<div class="j2store-bs">
			<div class="tabbable  tabs-left">
				<ul class="nav nav-tabs" data-tabs="tabs">
					<li class="active">
				    	<a href="#generalTab" data-toggle="tab">
				  			<?php echo Text::_('J2STORE_PRODUCT_TAB_GENERAL'); ?>
				   		 </a>
				     </li>
				     <li class="">
				     	<a href="#priceTab" data-toggle="tab">
				    		<?php echo Text::_('J2STORE_PRODUCT_TAB_PRICE'); ?>
				    	</a>
				     </li>
				     <li class="">
				     	<a href="#inventoryTab" data-toggle="tab">
				    		 <?php echo Text::_('J2STORE_PRODUCT_TAB_INVENTORY'); ?>
					     </a>
				     </li>
				     <li class="">
				     	<a href="#shippingTab" data-toggle="tab">
				     		<?php echo Text::_('J2STORE_PRODUCT_TAB_SHIPPING'); ?>
				     	</a>
				      </li>
				   </ul>
		...
		<?php echo  J2Html::hidden('variant_id', $this->item->j2store_variant_id,['id'=>'j2store_variant_id']);?>
