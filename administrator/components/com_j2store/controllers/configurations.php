    ...
    function add()
    {
        ...
        $vars->field_sets[] = array(
            ...
            'fields' => array(
                ...
                'hide_shipping_hide_shipping_until_address_selection_address_selection' => array(
                    'label' => 'J2STORE_CONF_AUTO_CALCULATE_SHIPPING_LABEL',
                    'type' => 'radio',
                    'name' => 'hide_shipping_hide_shipping_until_address_selection_address_selection',
                    'value' => isset($vars->item->hide_shipping_hide_shipping_until_address_selection_address_selection) && !is_null($vars->item->hide_shipping_hide_shipping_until_address_selection_address_selection) ? $vars->item->hide_shipping_hide_shipping_until_address_selection_address_selection : 1,
                    'options' => array('class' => 'btn-group'),
