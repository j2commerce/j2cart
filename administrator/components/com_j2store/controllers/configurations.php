 ...
 * @copyright Copyright (c) 2025 J2Commerce . All rights reserved.
        ...
        $vars->field_sets[] = array(
            ...
            'fields' => array(
                ...
                'load_jquery_ui' => array(
                    ...
                    'options' => array(
                        'options' => array(0 => Text::_('JNO'), 1 => Text::_('J2STORE_ONLY_FRONTEND'), 2 => Text::_('J2STORE_ONLY_BACKEND'), 3 => Text::_('J2STORE_BOTH_FRONTEND_AND_BACKEND')),'class' => 'form-select'
                    ),
                ...
                'load_timepicker' => array(
                    ...
                    'options' => array(
                        'options' => array(0 => Text::_('JNO'), 1 => Text::_('J2STORE_ONLY_FRONTEND'), 2 => Text::_('J2STORE_ONLY_BACKEND'), 3 => Text::_('J2STORE_BOTH_FRONTEND_AND_BACKEND'))
                    ),
        ...
        $vars->field_sets[] = array(
            ...
            'fields' => array(
                ...
                'store_billing_layout' => array(
                    ...
                    'value' => isset($vars->item->store_billing_layout) && !is_null($vars->item->store_billing_layout) ? $vars->item->store_billing_layout : '',
                ...
                'store_shipping_layout' => array(
                    ...
                    'value' => isset($vars->item->store_shipping_layout) && !is_null($vars->item->store_shipping_layout) ? $vars->item->store_shipping_layout : '',
                    'options' => array('class' => 'form-control', 'rows' => '10'),
                ),
                'store_payment_layout' => array(
                    ...
                    'value' => isset($vars->item->store_payment_layout) && !is_null($vars->item->store_payment_layout) ? $vars->item->store_payment_layout : '',
                    'options' => array('class' => 'form-control', 'rows' => '10'),
                ),
            )
        );
