...
/*ALTER TABLE `#__j2store_orderdiscounts` CHANGE `discount_amount` `discount_amount` DECIMAL(15,5) NULL DEFAULT '0.00000';
ALTER TABLE `#__j2store_orderdiscounts` CHANGE `discount_tax` `discount_tax` DECIMAL(15,5) NULL DEFAULT '0.00000';
*/
/*ALTER TABLE `#__j2store_orderitemattributes` CHANGE `orderitemattribute_price` `orderitemattribute_price` DECIMAL(15,5) NULL DEFAULT '0.00000';
*/
...
*/
/*ALTER TABLE `#__j2store_ordertaxes` CHANGE `ordertax_percent` `ordertax_percent` DECIMAL(15,5) NULL DEFAULT '0.00000';
ALTER TABLE `#__j2store_ordertaxes` CHANGE `ordertax_amount` `ordertax_amount` DECIMAL(15,5) NULL DEFAULT '0.00000';
*/
...
/*ALTER TABLE `#__j2store_shippingrates` CHANGE `shipping_rate_price` `shipping_rate_price` DECIMAL(15,5) NULL DEFAULT '0.00000';
ALTER TABLE `#__j2store_shippingrates` CHANGE `shipping_rate_handling` `shipping_rate_handling` DECIMAL(15,5) NULL DEFAULT '0.00000';
*/
/*ALTER TABLE `#__j2store_orderdiscounts` CHANGE `discount_amount` `discount_amount` DECIMAL(15,5) NULL DEFAULT '0.00000';
ALTER TABLE `#__j2store_orderdiscounts` CHANGE `discount_tax` `discount_tax` DECIMAL(15,5) NULL DEFAULT '0.00000';
*/
