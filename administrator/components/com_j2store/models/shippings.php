    ...
    public function getShippingRates(&$order)
    {
        ...
        if ($plugins) {
            foreach ($plugins as $plugin) {
                ...
                // If a shipping plugin does not implement onJ2StoreGetShippingOptions, it returns an empty array.
                // Without the empty($shippingOptions) condition, the plugin would be silently skipped and never return any rates.
                if (in_array(true, $shippingOptions, true) || empty($shippingOptions))  {
